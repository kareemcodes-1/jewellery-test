...
function FAQ() {
  return (
  <section className="w-full py-[3rem] lg:py-[6rem] px-[1.5rem] lg:px-[3rem]">
      ...
      <Accordion type="single" collapsible className="w-full">
        {faqs.map((faq, index) => (
          <AccordionItem key={index} value={`item-${index}`}>
            <AccordionTrigger className="text-[0.85rem] lg:text-[2rem] text-[#111] py-[1.2rem] lg:py-[1.8rem] hover:no-underline text-left">
              {faq.question}
            </AccordionTrigger>
